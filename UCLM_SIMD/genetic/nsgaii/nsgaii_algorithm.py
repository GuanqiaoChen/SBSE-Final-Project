...
from UCLM_SIMD.abstract_algorithm.evaluation_exception import EvaluationLimit
from UCLM_SIMD.genetic.abstract_genetic.abstract_genetic_algorithm import AbstractGeneticAlgorithm
from UCLM_SIMD.genetic.nsgaii.nsgaii_executer import NSGAIIExecuter
import time
...
class NSGAIIAlgorithm(AbstractGeneticAlgorithm):
    ...
    def __init__(self, execs=1, dataset_name="test", dataset: Dataset = None, random_seed=None, population_length=20,
